            ...
            <div class="pt-10">
                ...
                >
                    <swiper-slide v-for="(review, index) in reviews" :key="index">
                        <div class="border rounded-md overflow-hidden bg-brand-red-100">
    ...
    <section id="book">
        <div class="max-w-7xl mx-auto px-4 py-12 lg:py-20">
            ...
            <div class="mt-16">
                ...
                <div class="max-w-xl mx-auto flex flex-col items-center space-y-5 mt-20">
                    <div class="bg-brand-red-100 w-full p-5">
        ...
        <div class="max-w-5xl mx-auto bg-white rounded-lg shadow-lg py-5 md:py-10 lg:py-20 px-5">
            <div class="w-full max-w-3xl mx-auto">
                <div v-for="(faq, index) in faqs" :key="index" :class="{'border-b': index !== faqs.length - 1, 'border-b-0': index === faqs.length - 1}" class="transition py-4">
                    ...
                    <!-- Content -->
                    <div :class="faq.isOpen ? 'max-h-100' : 'max-h-0'" class="overflow-hidden transition-all duration-300 ease-in-out text-sm sm:text-base pt-2">
